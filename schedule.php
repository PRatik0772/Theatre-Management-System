...
<body>
    <div class="schedule-section">
        ...
        <div class="schedule-dates">
            ...
            <div class="schedule-item schedule-item-selected">April 14,2023</div>
            <div class="schedule-item">April 15,2019</div>
            <div class="schedule-item">April 16,2019</div>
    ...
    <td>
        ...
        <img src="img/movie-thumb-1.jpg" alt="" width="200" height="150">
        ...
        document.getElementById('details').addEventListener('click', function() {
            window.location.href = 'booking.php'; // Replace 'booking.php' with the actual file you want to redirect to
        });
        </script>
    </td>
