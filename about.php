...
<style>
    ...
    padding: 20px; /* Add padding for spacing */
        ...
        .about-us-container {
            font-family: 'Lato', sans-serif; /* Set Lato as the font for the container */
        }

        /* Style for the section */
        .about-us-section1 {
            font-family: 'Lobster', cursive; /* Set Lobster as the font for the section */
            font-size: 18px; /* Set the font size for the text */
            line-height: 1.5; /* Set the line height for the text */
        }
</style>
</head>
