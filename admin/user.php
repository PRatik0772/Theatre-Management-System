                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($run)) {
                                    ...
                                    // Determine the action text based on the is_banned value
                                    $action_text = ($is_banned == 0) ? 'Ban' : 'Unban';
                                    // Determine the action link based on the is_banned value
                                    $action_link = ($is_banned == 0) ? 'ban_user.php' : 'unban_user.php';
                                    ?>
                                    ...
                                    <tr align="center">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger">
                                                <a href="deleteusers.php?id=<?php echo $row['id']; ?>"
                                                    style="color: white; text-decoration: none;">Delete</a>
                                            </button>
                                        </td>

                                        <td>
                                            <a href="<?php echo $action_link; ?>?id=<?php echo $user_id; ?>"
                                                class="btn <?php echo ($is_banned == 1) ? 'btn-primary' : 'btn-danger'; ?>">
